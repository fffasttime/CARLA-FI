...
class BasicBlock_EI(nn.Module):
    expansion = 1

    def __init__(self, inplanes, planes, stride=1, downsample=None):
        super(BasicBlock_EI, self).__init__()
...
class ResNet_EI(nn.Module):

    def __init__(self, block, layers, num_classes=1000):
        self.inplanes = 64
        super(ResNet_EI, self).__init__()
...
def resnet50(pretrained=False, **kwargs):
    ...
    Args:
        pretrained (bool): If True, returns a model pre-trained on ImageNet
    """
    model = ResNet_EI(Bottleneck, [3, 4, 6, 3], **kwargs)
    if pretrained:
...
def resnet101(pretrained=False, **kwargs):
    ...
    Args:
        pretrained (bool): If True, returns a model pre-trained on ImageNet
    """
    model = ResNet_EI(Bottleneck, [3, 4, 23, 3], **kwargs)
    if pretrained:
...
def resnet152(pretrained=False, **kwargs):
    ...
    Args:
        pretrained (bool): If True, returns a model pre-trained on ImageNet
    """
    model = ResNet_EI(Bottleneck, [3, 8, 36, 3], **kwargs)
    if pretrained:
