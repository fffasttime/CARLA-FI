...
from .building_blocks import FC_EI
from .building_blocks import Join

class CoILICRA_EI(nn.Module):
    ...
    def __init__(self, params):
        ...
        if 'conv' in params['perception']:
            ...
            perception_fc = FC_EI(params={'neurons': [perception_convs.get_conv_output(sensor_input_shape)]
            ...
            resnet_module = importlib.import_module('network.models.building_blocks.resnet_ei')
        ...
        self.measurements = FC_EI(params={'neurons': [len(g_conf.INPUTS)] +
        ...
        self.speed_branch = FC_EI(params={'neurons': [params['join']['fc']['neurons'][-1]] +
        ...
        for i in range(params['branches']['number_of_branches']):
            branch_fc_vector.append(FC_EI(params={'neurons': [params['join']['fc']['neurons'][-1]] +
